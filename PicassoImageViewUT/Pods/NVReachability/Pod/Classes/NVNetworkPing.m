...
#pragma mark * NVNetworkPing

@interface NVNetworkPing ()
...
- (void)didFailWithError:(NSError *)error {
    id<NVNetworkPingDelegate>  strongDelegate;
...
static void SocketReadCallback(CFSocketRef s, CFSocketCallBackType type, CFDataRef address, const void *data, void *info) {
    ...
    obj = (__bridge NVNetworkPing *) info;
    assert([obj isKindOfClass:[NVNetworkPing class]]);
            ...
            if ( address.length >= sizeof(struct sockaddr) ) {
                ...
                switch (addrPtr->sa_family) {
                    case AF_INET: {
                        ...
                        if (self.addressStyle != NVNetworkPingAddressStyleICMPv6) {
                    ...
                    case AF_INET6: {
                        ...
                        self.IPAddress = [NSString stringWithFormat:@"%s", s];
                        if (self.addressStyle != NVNetworkPingAddressStyleICMPv4) {
                            self.hostAddress = address;
                            resolved = true;
                        }
                    } break;
