...
@protocol NVNetworkPingDelegate;

/*! Controls the IP address version used by SimplePing instances.
 */

typedef NS_ENUM(NSInteger, NVNetworkPingAddressStyle) {
    NVNetworkPingAddressStyleAny,          ///< Use the first IPv4 or IPv6 address found; the default.
    NVNetworkPingAddressStyleICMPv4,       ///< Use the first IPv4 address found.
    NVNetworkPingAddressStyleICMPv6        ///< Use the first IPv6 address found.
};
...
@interface NVNetworkPing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<NVNetworkPingDelegate> delegate;

/*! Controls the IP address version used by the object.
 *  \details You should set this value before starting the object.
 */

@property (nonatomic, assign, readwrite) NVNetworkPingAddressStyle addressStyle;
...
@protocol NVNetworkPingDelegate <NSObject>
