//
//  UIImage+pcs_Effects.m
//  ImageViewBase
//
//  Created by Courser on 2018/6/27.
//

#import "UIImage+pcs_Effects.h"
#import <Accelerate/Accelerate.h>

@implementation UIImage (pcs_Effects)

+ (UIImage *)pcs_accelerateBlurWithImage:(UIImage *)image withBlurNumber:(CGFloat)blur
{
...
- (UIImage *)pcs_applyBlurWithRadius:(CGFloat)blurRadius {
    return [self pcs_applyBlurWithRadius:blurRadius tintColor:nil saturationDeltaFactor:1.f maskImage:nil];
}

- (UIImage *)pcs_applyBlurWithRadius:(CGFloat)blurRadius tintColor:(UIColor *)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage *)maskImage
{
