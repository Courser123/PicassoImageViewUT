...
static const char *synctime_key = "d";
...
static const char *extratag_key = "t";

Construct_Data_cLogan *
construct_json_data_clogan(char *log, int flag, long long sync_time, long long local_time, char *thread_name,
    ...
    if (NULL != root) {
        if (NULL != map) {
            ...
            add_item_number_clogan(map, synctime_key, (double) sync_time);
            ...
            add_item_bool_clogan(map, ismain_key, ismain);
            add_item_string_clogan(map, extratag_key, extra_tag);
            ...
            if (NULL != construct_data) {
                ...
                if (NULL != temp_data) {
                    ...
                    construct_data = NULL;
                    printf_clogan("construct_json_data_clogan > malloc memory fail for temp_data\n");
                }
            }
            free(back_data);
        }
